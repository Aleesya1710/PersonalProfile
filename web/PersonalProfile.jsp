...
<body>
    <div class="wrapper">
        ...
        <div class="profile-box">
            <div class="section-title">👋🏻Hi, <%= request.getAttribute("name") %></div>
            <div class="grid">
                <div class="box">
            ...
            <div class="box">
                ...
                <div class="value" style="min-height:100px"><%= request.getAttribute("intro") %></div>
            </div>
            <div class="box">
                <div class="label">⚽ Hobbies</div>
                <div class="value"><%= request.getAttribute("hobbies") %></div>
            </div>
        </div>
    </div>
</body>
